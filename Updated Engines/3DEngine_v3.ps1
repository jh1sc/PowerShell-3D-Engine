...
$host.UI.RawUI.ForegroundColor = "black";$host.UI.RawUI.BackgroundColor = "Black"
...
[int]$nScreenWidth = 240; [int]$nScreenHeight = 120
...
while ($true) {
    ...
    $screen = $refr
    $colour += 1
    if($colour -gt 360){$colour = 0}
    $r = [math]::round([Math]::Sin($colour * [Math]::PI / 180) * 127)+ 128
    $g = [math]::round([Math]::Sin(($colour + 120) * [Math]::PI / 180) * 127)+ 128
    $b = [math]::round([Math]::Sin(($colour + 240) * [Math]::PI / 180) * 127 )+ 128

    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"L")) { LFF 10 }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"W")) { for ($j = 0; $j -lt $Vertexs.Length; $j++) { $y = $Vertexs[$j].y; $z = $Vertexs[$j].z; $Vertexs[$j].y = $y * $cosTheta - $z * $sinTheta; $Vertexs[$j].z = $y * $sinTheta + $z * $cosTheta } }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"S")) { for ($j = 0; $j -lt $Vertexs.Length; $j++) { $y = $Vertexs[$j].y; $z = $Vertexs[$j].z; $Vertexs[$j].y = $y * $cosTheta + $z * $sinTheta; $Vertexs[$j].z = $z * $cosTheta - $y * $sinTheta } }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"A")) { for ($j = 0; $j -lt $Vertexs.Length; $j++) { $x = $Vertexs[$j].x; $z = $Vertexs[$j].z; $Vertexs[$j].x = $x * $cosTheta + $z * $sinTheta; $Vertexs[$j].z = $z * $cosTheta - $x * $sinTheta } }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"D")) { for ($j = 0; $j -lt $Vertexs.Length; $j++) { $x = $Vertexs[$j].x; $z = $Vertexs[$j].z; $Vertexs[$j].x = $x * $cosTheta - $z * $sinTheta; $Vertexs[$j].z = $z * $cosTheta + $x * $sinTheta } }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"Q")) { for ($j = 0; $j -lt $Vertexs.Length; $j++) { $x = $Vertexs[$j].x; $y = $Vertexs[$j].y; $Vertexs[$j].x = $x * $cosTheta - $y * $sinTheta; $Vertexs[$j].y = $x * $sinTheta + $y * $cosTheta } }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"E")) { for ($j = 0; $j -lt $Vertexs.Length; $j++) { $x = $Vertexs[$j].x; $y = $Vertexs[$j].y; $Vertexs[$j].x = $x * $cosTheta + $y * $sinTheta; $Vertexs[$j].y = $y * $cosTheta - $x * $sinTheta } }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"Up")) { for ($j = 0; $j -lt $Vertexs.Length; $j++) { $Vertexs[$j].y -= 1 } }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"Down")) { for ($j = 0; $j -lt $Vertexs.Length; $j++) { $Vertexs[$j].y += 1 } }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"Left")) { for ($j = 0; $j -lt $Vertexs.Length; $j++) { $Vertexs[$j].x -= 1 } }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"Right")) { for ($j = 0; $j -lt $Vertexs.Length; $j++) { $Vertexs[$j].x += 1 } }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"Z")) { for ($j = 0; $j -lt $Vertexs.Length; $j++) { $Vertexs[$j].x *= 1.1; $Vertexs[$j].y *= 1.1; $Vertexs[$j].z *= 1.1 } $script:scale *= 1.1 }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"X")) { for ($j = 0; $j -lt $Vertexs.Length; $j++) { $Vertexs[$j].x *= 0.9; $Vertexs[$j].y *= 0.9; $Vertexs[$j].z *= 0.9 }  $script:scale *= 0.9 }
    if ($GetAsyncKeyState::GetAsyncKeyState([System.Windows.Forms.Keys]::"T")) { if ($toggle -gt "3") { $toggle = 0 }$toggle += 0.2; Toggle $toggle }
